...
int main()
{
 ...
 packages[0]=new Package( "Zhang Daxian", "1 Main St","Beijing","Daoding", 11111,
      "Mary Smith", "7 Elm St", "New York", "NY", 55555, 20.9, 0.5 );
      packages[1]=new TwoDayPackage("Lisa Klein", "5 Broadway", "Zhengzhou","Gaoxinqu",
      651455, "Bob George", "21 Pine Rd", "Cambridge","MA", 58691,
      10.5, 0.65, 2.0);
      ...
      {
          //cout<<"sender: ";
          cout<<packagePtr->getSenderAddress()<<"  ";
          cout<<packagePtr->getRecipientAddress()<<"  ";

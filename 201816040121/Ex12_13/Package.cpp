...
Package::Package(const string& n, const string& a, const string& c, const string& s, const string& pN, const string& ra, double w, double f)
{
	name = n;
	address = a;
	city = c;
...
//fuction to get receiver address

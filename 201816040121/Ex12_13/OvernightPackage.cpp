...
OvernightPackage::OvernightPackage(const string& n, const string& a, const string& c, const string& s, const string& pN, const string& ra,
	double w, double f, double onF)
	:Package(n, a, c, s, pN, ra,w, f)
{
	setOvernightFee(onF);
}

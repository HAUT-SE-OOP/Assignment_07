...
using namespace std;
OvernightPackage::OvernightPackage(string sendname,string receivename,string fromaddress,string sendaddress,string city,string county,string postalcode,double weight,double fee,double overnightfee)

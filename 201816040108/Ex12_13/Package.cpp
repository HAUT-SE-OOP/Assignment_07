...
Package::Package(const string &SenderName,const string &ReceiverName,const string &SenderAddress,const string &ReceiverAddress,const string &PostalCode,double ParcelWeighs,double Univalence)
{

...
TwoDayPackage::TwoDayPackage( string s,string r,string a,string c,string p,string pc,string ra,string rc,string rp,double w,double co,double tco )
   :Package( s,r,a,c,p,pc,ra,rc,rp,w,co )//use base-class constructor function to initialize data member
{
...
{
    Package::print();
    cout<<"two day fee: "<<gettwodayCost()<<endl;
}//end function

...
using namespace std;
OvernightPackage::OvernightPackage(const string &n,const string &m,const string &a,const string &b,const string &c,const string &d,const string &e,double f,double g,double h)
:Package(n,m,a,b,c,d,e,f,g)
{

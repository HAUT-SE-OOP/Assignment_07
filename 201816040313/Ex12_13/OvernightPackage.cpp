...
OvernightPackage::OvernightPackage(const string &sfirst,const string &slast,const string &afirst,const string &alast,const string &saddress,const string &aaddress,const string &scity,
            const string &acity,const string &sstate,const string &astate,const string &scode,const string &acode,double pweight,double pcost,double ecost)//constructor
...
double OvernightPackage::calculateCost()//calculate freight
{
    return (Package::getPerUnitCost()+getExtraCost())*Package::getPackageWeight();
}
void OvernightPackage::printMessage()const//print sender and addressee 's message
{

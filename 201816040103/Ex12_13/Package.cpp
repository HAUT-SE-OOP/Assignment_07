...
Package::Package(const string &nam,const string &nams,const string &add,const string &cit,const string &sta,
...
void Package::setName(string nam,string nams)
{
	name1 = nam;
	name2 = nams;
} 
...
void Package::print()
{
	cout<<getAddress()<<endl<<getCity()<<endl<<getState()<<endl;
}

...
Package::Package( const string &name, const string &ads, const string &city,
                 const string &state, const string &receiver, const string &code, double weight, double cost )
:sender(name), address(ads), livingcity(city), livingstate(state), receiverlivingcity(receiver), postalcode(code)
{
...
void Package::setReceiverlivingcity( const string &receiver)
{
    receiverlivingcity = receiver;
}

string Package::getReceiverlivingcity() const
{
    return receiverlivingcity;
}
...
void Package::print()
{
    ...
    "\nSender's address is " << getAddress() <<
    "\nLiving city is "<< getLivingcity() <<
    "\nLiving state is " << getLivingstate() <<
    "\nReceiver's address is " << getReceiverlivingcity() <<
